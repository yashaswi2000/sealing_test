...
static sgx_status_t SGX_CDECL sgx_ecall_enclave_unseal_sample(void* pms)
{
	CHECK_REF_POINTER(pms, sizeof(ms_ecall_enclave_unseal_sample_t));
	//
	// fence after pointer checks
	//
	sgx_lfence();
	ms_ecall_enclave_unseal_sample_t* ms = SGX_CAST(ms_ecall_enclave_unseal_sample_t*, pms);
	sgx_status_t status = SGX_SUCCESS;



	ms->ms_retval = ecall_enclave_unseal_sample();
...
SGX_EXTERNC const struct {
	...
	2,
	{
		{(void*)(uintptr_t)sgx_ecall_enclave_unseal_sample, 0, 0},
...
sgx_status_t SGX_CDECL ocall_enclave_unseal_sample(const char* str)
{
	sgx_status_t status = SGX_SUCCESS;
	size_t _len_str = str ? strlen(str) + 1 : 0;

	ms_ocall_enclave_unseal_sample_t* ms = NULL;
	size_t ocalloc_size = sizeof(ms_ocall_enclave_unseal_sample_t);
	void *__tmp = NULL;
	...
	ms = (ms_ocall_enclave_unseal_sample_t*)__tmp;
	__tmp = (void *)((size_t)__tmp + sizeof(ms_ocall_enclave_unseal_sample_t));
	ocalloc_size -= sizeof(ms_ocall_enclave_unseal_sample_t);
